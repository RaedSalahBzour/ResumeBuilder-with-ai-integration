      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="w-full sm:max-w-36 h-48 flex flex-col
           items-center justify-center rounded-lg gap-2 text-slate-600
            border border-dashed border-slate-300 group hover:border-purple-500
             hover:shadow-lg transition-all duration-300 cursor-pointer bg-white"
          >
            <UploadCloudIcon
              className="size-11 transition-all duration-300 p-2.5
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  className="absolute top-1 right-1 hidden items-center gap-1 
                group-hover:flex"
                >
                  <TrashIcon
                    onClick={() => deleteResume(resume._id)}
                    className="size-7 p-1.5 hover:bg-white/50 
                  rounded text-slate-700 transition-colors cursor-pointer"
                  />
                  <PencilIcon
                    onClick={() => {
        ...
        {showCreateResume && (
          <form
            ...
            onClick={() => setShowCreateResume(false)} // close modal when clicking outside
          >
            <div
        ...
        {showUploadResume && (
          <form
            ...
            backdrop-blur z-10 flex items-center justify-center"
            ...
            >
              ...
              <div>
                ...
                >
                 ...
                 text-slate-400 hover:border-green-500 hover:text-green-700 
        ...
        {editResumeId && (
          <form
            onSubmit={editTitle}
            className="fixed inset-0 bg-black/70 backdrop-blur z-10 flex items-center justify-center"
            onClick={() => setEditResumeId("")} // close modal when clicking outside
          >
            <div
              onClick={e => e.stopPropagation()} // prevent closing when clicking inside
              className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6"
