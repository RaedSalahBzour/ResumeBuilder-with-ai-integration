            ...
            >
              ...
              <hr
                className="absolute top-0 left-0 h-1 bg-gradient-to-r
                 from-green-500 to-green-600 border-none transition-all
                  duration-2000"
                style={{
                  width: `${
          ...
          <div className="lg:col-span-7 max-lg:mt-6">
            <div className="relative w-full">
              ...
              >
                ...
                rounded-lg ring ring-blue-300 hover:ring-blue-400 
                transition-colors"
                  >
                ...
                <button
                 ...
                 bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600
                  rounded-lg ring ring-purple-300 hover:ring-purple-400 
                  transition-colors"
                >
                  {resumeData.public ? (
                ...
                py-2 text-xs bg-gradient-to-br from-green-100
                 to-green-200 text-green-600 rounded-lg ring ring-green-300
                  hover:ring-green-400 transition-colors"
                >
