...
const ColorPicker = ({ selectedColor, onChange }) => {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div
          className="absolute top-full left-0 w-60 p-3 mt-2 grid 
        grid-cols-4 gap-2 z-10 bg-white rounded-md border
         border-gray-200 shadow-sm  max-h-[200px] overflow-y-auto"
        >
          {colors.map(color => (
            <div
              key={color.value}
