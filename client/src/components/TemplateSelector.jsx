...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  const templates = [
    ...
    },
    {
      id: "modern",
      name: "Modern",
      preview: "A contemporary layout with bold headings and an elegant design",
    },
    {
      id: "minimal-image",
      name: "Minimal Image",
  ...
  return (
    <div className="relative ">
      ...
      {isOpen && (
        <div
          className="absolute top-full w-64 p-3 mt-2 
        space-y-3 z-10 bg-white rounded-md border
