        ...
        <main className="col-span-2 p-8 pt-0">
          ...
          {data.professional_summary && (
            <section className="mb-8">
              ...
              <p className="text-zinc-700 leading-relaxed text-wrap  break-words">
                {data.professional_summary}
              </p>
            </section>
          )}
              ...
              <div className="space-y-6 mb-8">
                {data.experience.map((exp, index) => (
                  <div key={index}>
                    ...
                    {exp.description && (
                      <ul
                        className="list-disc text-wrap list-inside text-sm
                       text-zinc-700 leading-relaxed space-y-1"
                      >
                  ...
                  <div key={index}>
                    ...
                    {project.description && (
                      <ul
                       ...
                       text-sm text-zinc-700  space-y-1 text-wrap  break-words"
                      >
