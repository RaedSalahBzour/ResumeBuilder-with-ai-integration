    ...
    <div className="max-w-4xl mx-auto p-8 bg-white text-gray-900 font-light">
      ...
      <header className="mb-10">
        ...
        {data.personal_info?.profession && (
          <div className="text-gray-400 font-weight-300 mb-3 text-xl">
            {data.personal_info.profession}
          </div>
        )}
      ...
      {data.professional_summary && (
        <section className="mb-10">
          ...
          <p className=" text-gray-700 text-wrap  break-words">
            {data.professional_summary}
          </p>
        </section>
      )}
              ...
              <div key={index}>
                ...
                {exp.description && (
                  <div
                    ...
                    leading-relaxed whitespace-pre-line text-wrap  break-words"
                  >
                    {exp.description}
                  </div>
                )}
          ...
          <div className="space-y-4">
            {data.projects.map((proj, index) => (
              ...
              >
                ...
                <p className="text-gray-600 text-wrap  break-words">
                  {proj.description}
                </p>
              </div>
            ))}
